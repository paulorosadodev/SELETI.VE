...
def nova_tarefa(request, id_vaga):
    ...
    try:   
        ...
        tarefa.save()
        messages.add_message(request, constants.SUCCESS, 'Tarefa adcionada com sucesso')
...
def realizar_tarefa(request, id):
    ...
    tarefa.save()    
    messages.add_message(request, constants.SUCCESS, 'Parabéns! Você realizou uma tarefa')
